        ...
        <div className="customer-profile-page">
            ...
            <div className="customer-profile-container">
                <div className="customer-profile-header">
                    <h1 className="customer-profile-title">Your Profile</h1>
                    <p className="customer-profile-subtitle">View and manage your personal information</p>
                </div>
                ...
                <div className="customer-profile-card">
                    ...
                    <div className="customer-profile-welcome">
                        <h2 className="customer-profile-welcome-name">Hi, {user.firstName}!</h2>
                        <p className="customer-profile-welcome-message">Welcome to your profile dashboard</p>
                    </div>
                        ...
                        <div className="customer-profile-main">
                            <div className="customer-profile-section">
                                ...
                                <div className="customer-profile-item">
                                    ...
                                    <div className="customer-profile-item-content">
                                        <div className="customer-profile-item-label">Full Name</div>
                                ...
                                <div className="customer-profile-item">
                                    ...
                                    <div className="customer-profile-item-content">
                                        <div className="customer-profile-item-label">Email Address</div>
                                ...
                                <div className="customer-profile-item">
                                    ...
                                    <div className="customer-profile-item-content">
                                        <div className="customer-profile-item-label">Phone Number</div>
                                ...
                                <div className="customer-profile-item">
                                    ...
                                    <div className="customer-profile-item-content">
                                        <div className="customer-profile-item-label">Gender</div>
                                ...
                                <div className="customer-profile-item">
                                    ...
                                    <div className="customer-profile-item-content">
                                        <div className="customer-profile-item-label">Date of Birth</div>
                                ...
                                <div className="customer-profile-item">
                                    ...
                                    <div className="customer-profile-item-content">
                                        <div className="customer-profile-item-label">Age</div>
                                        <div className="customer-profile-item-value">{calculateAge(user.dob)} years</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="customer-profile-address">
                                ...
                                <p className="customer-profile-address-content">
                                    {user?.address?.houseNumber}, {user?.address?.streetName}, {user?.address?.state}, {user?.address?.country}
                                </p>
                            </div>
                        </div>
