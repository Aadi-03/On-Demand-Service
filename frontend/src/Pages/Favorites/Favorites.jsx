...
const Favorites = () => {
        ...
        const handleRemoveBookmard = (id, name) => {
                const newProviderData = providerData.filter((provider) => provider.providerId !== id);
                                        ...
                                        {providerData.length > 0 ? (
                                                providerData.map((provider, index) => (
                                                        <div className="bookmark-container">
                                                                <img src={bookmarked} alt="" className="bookmark" onClick={() => handleRemoveBookmard(provider.providerId, provider.providerName)}/>
                                                                <Card
                                                                        key={index}
